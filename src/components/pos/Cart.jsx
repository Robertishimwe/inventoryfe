...
function Cart() {
  ...
  // Added a function to handle input change for quantity
  ...
  return (
    <>
      ...
      {/* Added disabled condition for the Confirm Sell button */}
      <div className="flex justify-end mb-6 gap-4 px-8">
        <Button onClick={handleConfirmSell} disabled={isPending || totalPrice <= 0 || cart.length <= 0}>
